  ...
  function SearchBox(cm) {
    ...
    function bindKeys() {
      ...
      var obj = {
        ...
        Tab: function() {
          if (self.activeInput === self.replaceInput) self.searchInput.focus();
    ...
    this.find = function(skipCurrent, backwards) {
      ...
      find(value, options, function(searchCursor) {
        ...
        cm.setCursor(current.from, current.to);
    ...
    function find(value, options, callback) {
      ...
      (next = searchCursor.findNext.bind(searchCursor)), (prev = searchCursor.findPrevious.bind(searchCursor)), (matches = searchCursor.matches.bind(searchCursor));
    ...
    this.replace = function() {
      ...
      var isSelection = !!cm.getSelection();
    ...
    function addHtml() {
      ...
      var html = [
        ...
        '<button type="button" action="replaceAndFindNext"  style="width: 54px;" class="ace_replacebtn">Replace</button>',
        '<button type="button" action="replaceAll" style="width: 27px;" class="ace_replacebtn">All</button>',
        '</div>',
