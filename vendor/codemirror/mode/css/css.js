!(function(e) {
  ...
  _.defineMode('css', function(e, t) {
    var r = t.inline;
    t.propertyKeywords || (t = _.resolveMode('text/css'));
    var a,
      i,
      n = e.indentUnit,
      l = t.tokenHooks,
    ...
    function x(e, t) {
      return e.next(), e.match(/\s*[\"\')]/, !1) ? (t.tokenize = null) : (t.tokenize = v(')')), (a = '('), null;
    }
    function z(e, t, r) {
    ...
    function C(e) {
      ...
      i = h.hasOwnProperty(t) ? 'atom' : g.hasOwnProperty(t) ? 'keyword' : 'variable';
    }
    var B = {
      top: function(e, t, r) {
        ...
        if (/^@(media|supports|(-moz-)?document|import)$/i.test(e)) return j(r, t, 'atBlock');
      ...
      block: function(e, t, r) {
        if ('word' != e) return 'meta' == e ? 'block' : f || ('hash' != e && 'qualifier' != e) ? B.top(e, t, r) : ((i = 'error'), 'block');
      ...
      documentTypes: function(e, t, r) {
        return 'word' == e && o.hasOwnProperty(t.current()) ? ((i = 'tag'), r.context.type) : B.atBlock(e, t, r);
      },
      atBlock: function(e, t, r) {
        return '(' == e
          ? j(r, t, 'atBlock_parens')
          : '}' == e || ';' == e
          ? K(e, t, r)
          : '{' == e
          ? P(r) && j(r, t, f ? 'block' : 'top')
          : 'interpolation' == e
          ? j(r, t, 'interpolation')
          : ('word' == e &&
      ...
      atComponentBlock: function(e, t, r) {
        return '}' == e ? K(e, t, r) : '{' == e ? P(r) && j(r, t, f ? 'block' : 'top', !1) : ('word' == e && (i = 'error'), r.context.type);
      },
      atBlock_parens: function(e, t, r) {
        return ')' == e ? P(r) : '{' == e || '}' == e ? K(e, t, r, 2) : B.atBlock(e, t, r);
      },
      restricted_atBlock_before: function(e, t, r) {
        return '{' == e ? j(r, t, 'restricted_atBlock') : 'word' == e && '@counter-style' == r.stateArg ? ((i = 'variable'), 'restricted_atBlock_before') : q(e, t, r);
      },
      restricted_atBlock: function(e, t, r) {
        return '}' == e
          ...
          : 'word' == e
          ? ((i =
              ('@font-face' == r.stateArg && !m.hasOwnProperty(t.current().toLowerCase())) || ('@counter-style' == r.stateArg && !b.hasOwnProperty(t.current().toLowerCase()))
                ? 'error'
                : 'property'),
            'maybeprop')
          : 'restricted_atBlock';
      ...
      keyframes: function(e, t, r) {
        return 'word' == e ? ((i = 'variable'), 'keyframes') : '{' == e ? j(r, t, 'top') : q(e, t, r);
      },
      at: function(e, t, r) {
    ...
    return {
      startState: function(e) {
        return { tokenize: null, state: r ? 'block' : 'top', stateArg: null, context: new z(r ? 'block' : 'top', e || 0, null) };
      },
      token: function(e, t) {
          ...
          function(e, t) {
            ...
            return '@' == r
              ...
              ? /[,+>*\/]/.test(r)
                ...
                ? w(null, r)
                : e.match(/[\w-.]+(?=\()/)
                ? (/^(url(-prefix)?|domain|regexp)$/.test(e.current().toLowerCase()) && (t.tokenize = x), (a = 'variable'), 'variable callee')
                : /[\w\\\-]/.test(r)
              ...
              ? (e.eatWhile(/[\w.%]/), (a = 'unit'), 'number')
              : e.match(/^-[\w\\\-]*/)
              ? (e.eatWhile(/[\w\\\-]/), (a = e.match(/^\s*:/, !1) ? 'variable-definition' : 'variable'), 'variable-2')
              : e.match(/^\w+-/)
              ? (a = 'meta')
              : void 0;
          }
        )(e, t);
        return r && 'object' == typeof r && ((a = r[1]), (r = r[0])), (i = r), 'comment' != a && (t.state = B[t.state](a, e, t)), i;
      },
      indent: function(e, t) {
        var r = e.context,
          o = t && t.charAt(0),
  ...
  _.registerHelper('hintWords', 'css', y),
    _.defineMIME('text/css', {
      documentTypes: r,
      mediaTypes: i,
      mediaFeatures: n,
    ...
    _.defineMIME('text/x-scss', {
      ...
      tokenHooks: {
        '/': function(e, t) {
          return e.eat('/') ? (e.skipToEnd(), ['comment', 'comment']) : e.eat('*') ? (t.tokenize = w)(e, t) : ['operator', 'operator'];
        },
        ':': function(e) {
